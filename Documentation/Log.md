...
> Warning: This variable is **not** thread safe (for performance reasons). If you wish to customize its value please do so just once on app launch, or before using any of Log's components.
